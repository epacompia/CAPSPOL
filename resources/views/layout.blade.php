          ...
          <ul class="treeview-menu">
            ...
            <li><a href="mailbox_read_mail.html"><i class="ti-more"></i>Read</a></li>
                    ...
                    <li class="treeview">
                        ...
                        <ul class="treeview-menu">
                            <li><a href="profile.html"><i class="ti-more"></i>Personal Policial Lima</a></li>
                            <li><a href="invoice.html"><i class="ti-more"></i>Personal Policial Provincia</a></li>
                            <li><a href="gallery.html"><i class="ti-more"></i>Personal Civil</a></li>
                        </ul>
                    </li>

                    <li class="header nav-small-cap">Mantenimientos</li>

                    {{-- MANTENIMIENTO PARA GRADOS --}}
                    <li class="treeview">
                        <a href="#">
                        ...
                        <ul class="treeview-menu">
                            <li><a href="components_alerts.html"><i class="ti-more"></i>Grados</a></li>
                        </ul>
                    </li>
                    {{-- FIN DE MANTENIMIENTO DE GRADOS --}}

                    {{-- MANTENIMIENTO PARA SUB UNIDADES --}}
                    <li class="treeview">
                        <a href="#">
                            <i data-feather="grid"></i>
                            <span>Sub unidades Dircocor</span>
                            <span class="pull-right-container">
                                <i class="fa fa-angle-right pull-right"></i>
                            </span>
                        </a>
                        <ul class="treeview-menu">
                            <li><a href="components_alerts.html"><i class="ti-more"></i>Sub unidades</a></li>
                        </ul>
                    </li>
                    {{-- FIN DE MANTENIMIENTO DE SUB UNIDADES --}}

                    {{-- MANTENIMIENTO PARA CARGOS --}}
                    <li class="treeview">
                        <a href="#">
                            <i data-feather="grid"></i>
                            <span>Cargos</span>
                        ...
                        <ul class="treeview-menu">
                            <li><a href="components_alerts.html"><i class="ti-more"></i>Cargos</a></li>
                        </ul>
                    </li>
                    {{-- FIN DE MANTENIMIENTO DE CARGOS --}}

                    {{-- MANTENIMIENTO PARA ESPECIALIDADES --}}
                    <li class="treeview">
                        <a href="#">
                            <i data-feather="grid"></i>
                        ...
                        <ul class="treeview-menu">
                            <li><a href="components_alerts.html"><i class="ti-more"></i>Especialidades</a></li>
                        </ul>
                    </li>
                    {{-- FIN DE MANTENIMIENTO DE ESPECIALIDADES --}}

                    {{-- MANTENIMIENTO PARA COMISARIAS --}}
                    <li class="treeview">
                        <a href="#">
                            <i data-feather="grid"></i>
                        ...
                        <ul class="treeview-menu">
                            <li><a href="components_alerts.html"><i class="ti-more"></i>Comisarias</a></li>
                        </ul>
                    </li>
                    {{-- FIN DE MANTENIMIENTO DE COMISARIAS --}}

                    <li class="header nav-small-cap">REPORTES</li>
                    <li class="treeview">
                        <a href="#">
                            <i data-feather="grid"></i>
                            <span>Cuadro Numérico Lima</span>
                            <span class="pull-right-container">
                                <i class="fa fa-angle-right pull-right"></i>
                            </span>
                        </a>
                        <ul class="treeview-menu">
                            <li><a href="components_alerts.html"><i class="ti-more"></i>Cuadro Numérico Lima</a></li>
                        </ul>
                    </li>
                    <li class="treeview">
                        <a href="#">
        ...
        <footer class="main-footer">
            <div class="pull-right d-none d-sm-inline-block">
                <ul class="nav nav-primary nav-dotted nav-dot-separated justify-content-center justify-content-md-end">
                    <li class="nav-item">
                        <a class="nav-link" href="#">Dircocor</a>
                    </li>
                </ul>
            </div>
