...
{
    public partial class AddUserTablesForUsersRolesEtc : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Landline = table.Column<string>(type: "nvarchar(9)", maxLength: 9, nullable: true),
                    Date_Of_Birth = table.Column<DateTime>(type: "datetime2", nullable: false),
                    Personal_Email = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: true),
                    Civil_Status = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Last_Ascent = table.Column<DateTime>(type: "datetime2", nullable: true),
