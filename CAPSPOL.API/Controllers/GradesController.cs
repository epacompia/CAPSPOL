...
namespace CAPSPOL.API.Controllers
{
    public class GradesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Description")] Grade grade)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Description")] Grade grade)
        {
            if (id != grade.Id)
            {
                return NotFound();
